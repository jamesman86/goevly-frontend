<template>
  <div>
    ...
    <!-- Hero de categoría -->
    <section class="category-hero tours-hero">
      <div class="hero-overlay"></div>
      <div class="hero-content">
        <h1>Tours en Santa Marta</h1>
        <p>Las mejores experiencias para explorar el Caribe colombiano</p>
      </div>
    </section>
...
export default {
  ...
  methods: {
    cargarCards() {
      ...
      // Combinar con mockData de tours
      const mock = mockNegocios.filter(n => n.category === 'tours')
...
.tours-hero {
  background-image: url('@/assets/playatayrona.jpg');
}
