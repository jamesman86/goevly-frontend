<template>
  <div>
    ...
    <section class="category-hero guias-hero">
      <div class="hero-overlay"></div>
      <div class="hero-content">
        <h1>Guías turísticos en Santa Marta</h1>
        <p>Expertos locales que conocen cada rincón de la ciudad</p>
      </div>
    </section>
